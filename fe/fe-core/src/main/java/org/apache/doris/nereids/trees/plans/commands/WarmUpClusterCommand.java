...
public class WarmUpClusterCommand extends StatementBase implements NotFallbackInParser {
    ...
    public WarmUpClusterCommand(String dstClusterName, String srcClusterName, boolean isForce,
    ...
    public WarmUpClusterCommand(String dstClusterName, List<Map<TableName, String>> tableList, boolean isForce) {
        this.dstClusterName = dstClusterName;
